...
export default function App() {
  ...
  const handleStartWalk = async () => {
    ...
    pushRoomState({
      ...
      questAttempt: targetAttempt
    });
  };

  // ✅ handleNextStation（統合版）
      ...
      img.onload = async () => {
        ...
        try {
          ...
          const uploadResponse = await fetch(
            `/api/upload?filename=${roomId}-${Date.now()}.jpg`,
            { method: 'POST', body: blobData }
          );
